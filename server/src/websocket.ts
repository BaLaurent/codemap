...
import { GraphData, FileActivityEvent, AgentThinkingState, LayoutUpdateData, ProjectInfo, PendingRequestInfo, PermissionResolvedInfo } from './types.js';
...
export class WebSocketManager {
  ...
  broadcast(type: string, data: GraphData | FileActivityEvent | AgentThinkingState[] | LayoutUpdateData | ProjectInfo[] | PendingRequestInfo | PermissionResolvedInfo, projectId?: string): void {
